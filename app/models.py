...
class Recipes(models.Model):
    ...
    num_preparations = models.IntegerField(blank=True, default=1)
    num_servings = models.IntegerField(blank=True, default=1)
    preparation_time = models.IntegerField()
    preparation_time_unit = models.CharField(max_length=65, default='')
    preparation_steps = models.TextField()
    preparation_steps_is_html = models.BooleanField(default=False)
    is_published = models.BooleanField(default=False)
    servings_unit = models.CharField(max_length=65, blank=True, default='dd')
